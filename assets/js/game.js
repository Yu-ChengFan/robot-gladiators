...
var fightOrSkip = function() {
    ...
    if (promptFight === "" || promptFight ===null) {
        window.alert("You need to provide a valid answer! Please retry!");
        return fightOrSkip();
    }
    if (promptFight === "skip") {
        ...
        if (confirmSkip) {
            ...
            window.alert("Money left: " + playerInfo.money + " dollars")
            return true;
        }
...
var playerInfo = {
    ...
    refillHealth: function() {
        if (this.money >= 7) {
            ...
            this.health += 20;
            this.money -=7;
            window.alert("Money left: " + this.money + " dollars")
        } else {
    ...
    upgradeAttack: function(){
        if (this.money >= 7) {
            ...
            this.attack += 6;
            this.money -= 7;
            window.alert("Money: " + this.money + " dollars")
        }
        else {
            window.alert("You don't have enough money!")
        }
